...
import com.jones.myquiz.ui.screens.joinquiz.viewModel.JoinQuizViewModel
...
class JoinQuizViewModelImpl @Inject constructor(
    ...
    private val _quiz: MutableStateFlow<Quiz> = MutableStateFlow(Quiz(questionTitles = emptyList(), options = emptyList(), answers = emptyList(), timeLimit = 0, timeCreated = 0))
